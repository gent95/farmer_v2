...
<div id="main">
        ...
        <div class="navbar-inner">
            <div class="brand">
                ...
                <li style="list-style-type: none;" id="userInfo" class="dropdown">
                    <c:choose>
                        <c:when
                                test="${fns:getUser().photo!=null&&fns:getUser().photo!=''}">
                            <img src="${fns:getUser().photo}"
                                 style="border-radius: 50%; height: 89px; width: 89px;"/>
                            <br/>
                        </c:when>
                        <c:otherwise>
                    ...
                    </c:choose> <a class="dropdown-toggle" data-toggle="dropdown" href="#"
                                   title="个人信息"> <span>${fns:getUser().name}</span> <span
            ...
            <div>
                ...
                <ul id="userControl" class="nav pull-right"
                    ...
                    <div>
                        <p style="font-size: 30px; margin-bottom: 20px"><%=new SimpleDateFormat("yyyy/MM/dd ").format(new Date())%>
                        </p>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid" style="font-size: 12px;">
