        ...
        <tr>
            ...
            <td>${user.mobile}</td>
                ...
                <shiro:hasPermission name="sys:user:edit"><td>
                    <div class="two"><a href="${ctx}/sys/user/form?id=${user.id}">修改</a></div>
                    <div class="one"><a href="${ctx}/sys/user/delete?id=${user.id}" onclick="return confirmx('确认要删除该用户吗？', this.href)">删除</a></div>
