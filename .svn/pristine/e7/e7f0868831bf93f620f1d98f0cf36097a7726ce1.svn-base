...
public class GrowContoller {
    ...
    public Map getDatectionDates(){
        ...
        List<DatectionDate> datectionDates = datectionDateService.findByCreateTime();
        ...
        for (int i = datectionDates.size()-1; i > -1;i--){
            winSpeed.add(datectionDates.get(i).getWindSpeed());
            airTemperature.add(datectionDates.get(i).getAirTemperature());
            humidity.add(datectionDates.get(i).getHumidity());
            rainV.add(datectionDates.get(i).getRainV());
            radiate.add(datectionDates.get(i).getRadiate());
            windDirection.add(datectionDates.get(i).getWindDirection());
            evaporation.add(datectionDates.get(i).getEvaporation());
            date.add(DateUtils.formatTime(datectionDates.get(i).getCreateDate()));
        }
    ...
    @ResponseBody
    public Map getNodeAndRelayCount(String id){
        Map result = new HashMap();
